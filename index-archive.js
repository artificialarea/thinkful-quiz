// archiving original index.js 
// because want to start over with function stubs etc.
// so saved this version for possible reference later
...
$(function() {
  renderView();
  handleStartQuiz();
  // handleQuizCycleTEMP(); // temp to test quiz question views easily
  handleFeedback();

  // recommended Function Stubs
  // handleQuestionView();
